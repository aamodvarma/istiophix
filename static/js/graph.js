const dataset = [34.6, 17.3, 12.3, 9.3, 8.2, 8.2, 4.9, 3.1, 1.1] // let colors = ['#8dd3c7', '#ffffb3', '#bebada', '#fb8072', '#80b1d3', '#fdb462', '#b3de69', '#fccde5', '#d9d9d9', '#bc80bd']; // let colors = 
const colors = ['#ffffb3', 'Accomodation', 'Assistance', 'Car', 'Materials & Testing', 'Jerseys', 'Miscellaneous', 'Paint', 'Equipments']
